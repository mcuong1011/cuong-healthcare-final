...
CLINICAL_SERVICE = config('CLINICAL_SERVICE')
PHARMACY_SERVICE = config('PHARMACY_SERVICE')
LAB_SERVICE = config('LAB_SERVICE')
INSURANCE_SERVICE = config('INSURANCE_SERVICE')
NOTIFICATION_SERVICE = config('NOTIFICATION_SERVICE')
VIRTUALROBOT_SERVICE = config('VIRTUALROBOT_SERVICE') 
CHATBOT_SERVICE = config('CHATBOT_SERVICE')
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=9999),  # hoặc 100 năm cũng được
