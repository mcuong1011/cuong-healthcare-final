...
SECRET_KEY = os.environ.get('SECRET_KEY', 'doctor-insecure-default-key')
...
INSTALLED_APPS = [
    ...
    'doctor_app', # <-- Add your doctor app here
]
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_doctor') # Default specific name
