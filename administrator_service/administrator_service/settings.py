"""
Django settings for administrator_service project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'admin-insecure-default-key')
...
INSTALLED_APPS = [
    ...
    'administrator_app', # <-- Add your app here
]
...
ROOT_URLCONF = 'administrator_service.urls'
...
WSGI_APPLICATION = 'administrator_service.wsgi.application'
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_admin') # Default specific name
