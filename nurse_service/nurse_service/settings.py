"""
Django settings for nurse_service project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'nurse-insecure-default-key')
...
INSTALLED_APPS = [
    ...
    'nurse_app', # <-- Add your nurse app here
]
...
ROOT_URLCONF = 'nurse_service.urls'
...
# Database
DB_NAME = os.environ.get('DB_NAME', 'sand_fp_db_nurse') # Default specific name
